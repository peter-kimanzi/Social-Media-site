...
//     exit();
// }
// $moveResult = move_uploaded_file($fileTmpLoc, "../themes/images/$fileName");
// if ($moveResult != true) {
//  echo "
// <p id='error_msg' onclick='hide_notify()'>
...
//     $uploaded_sql = "UPDATE users SET image= :fileName WHERE username= :s_un";
...
//   $target_dir = "themes/dolphin/images/";
...
//      // Insert record
//      $query = "update users set cover='".$name."' where username='".$username."' ";
//      $db->query($query);
//
//      // Upload file
